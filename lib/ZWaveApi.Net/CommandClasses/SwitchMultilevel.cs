...
namespace ZWaveApi.Net.CommandClasses
{
    ...
    /// </summary>
    [DataContract]
    public class SwitchMultilevel : GenericCommandClass, IBinarySwitch
    {
        private byte level;
        ...
        public SwitchMultilevel(ZWaveNode node, byte instanceId)
            : base(node, instanceId, CommandClass.SwitchMultilevel)
        {
        }
        ...
        public override void RequestState()
        {
            ZWavePort.AddMessage(new Message(MessageType.Request,
                                 ...
                                 this.Node.NodeId,
                                 new byte[] { (byte)this.CommandClass, (byte)SwitchMultilevelCmd.Get }),
        ...
        /// <summary>
        /// Get the status of the Multilevel Switch Pct. of level
        /// </summary>
        [DataMember]
        public byte Level
        {
            ...
            set
            {
                ...
                ZWavePort.AddMessage(new Message(MessageType.Request,
                                                 ZWaveFunction.SendData,
                                                 this.Node.NodeId,
                                                 new byte[] { (byte)this.CommandClass, (byte)SwitchMultilevelCmd.Set, this.level }),
                                                 ZWaveMessagePriority.Interactive);
            }
        }
        ...
        public void ON()
        {
            ZWavePort.AddMessage(new Message(MessageType.Request,
                                 ZWaveFunction.SendData,
                                 this.Node.NodeId,
                                 new byte[] { (byte)this.CommandClass, (byte)SwitchMultilevelCmd.Set, (byte)BinaryStatus.On }),
                                 ZWaveMessagePriority.Interactive);
        }
        ...
        public void OFF()
        {
            ZWavePort.AddMessage(new Message(MessageType.Request,
                                 ZWaveFunction.SendData,
                                 this.Node.NodeId,
                                 new byte[] { (byte)this.CommandClass, (byte)SwitchMultilevelCmd.Set, (byte)BinaryStatus.Off }),
                                 ZWaveMessagePriority.Interactive);
        }
