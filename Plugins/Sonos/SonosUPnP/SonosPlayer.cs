...
namespace IoStorm.Sonos
{
    public class SonosPlayer
    {
        ...
        internal SonosPlayer(Qlue.Logging.ILogFactory logFactory, string name, string uuid)
        {
            this.log = logFactory.GetLogger("SonosPlayer");
        ...
        private void ChangeTriggered(UPnPStateVariable sender, object value)
        {
            ...
            this.log.Trace("LastChange from {0}", UUID);
//            this.log.Trace("LastChange from {0}, new state: {1}", UUID, newState);
